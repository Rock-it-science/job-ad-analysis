...
def add_new_ads(filename):
    ...
    with open('unique_ads.csv', 'a', newline='') as csv_file:
...
def build_unique_ads():
    ...
    with open('unique_ads.csv', 'w', newline='') as csv_file:
        csvwriter = csv.writer(csv_file)
        ...
        for root, dir, name in os.walk('raw_ads/'):
            for file in name:
                # Open JSON file
...
#build_unique_ads()
#add_new_ads('raw_ads/job ads-Software Developer-11-24_14_26_53.json')